...
def main(N = 5, useN=None, dim = 2, kT = 1, seed=42, dt = 1.0e-3, spring_constant = 1.0, length_constant = 1.0, stride = 1, runs=100, rname=0, withdata = None, saveovito=0, semilog=1, plotthings = True, maxtraj = 100, redo=0):
    ...
    # PSYS = f"a-{N*kT+1}-non-linear-Spring-data-brownian_EM"
